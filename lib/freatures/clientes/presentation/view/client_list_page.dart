            ...
            child: viewModel.clients.isEmpty
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.people_outline, size: 64, color: AppColors.cinzaNeve.withOpacity(0.5)),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: AppColors.cianoFrio.withOpacity(0.12),
                                  border: Border.all(color: AppColors.cianoFrio.withOpacity(0.3)),
                                ),
                                child: Center(
                                  child: Text(
                              ...
                              GestureDetector(
                                onTap: () => Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (_) => ClientFormPage(client: c)),
                                ...
                                child: Container(
                                  ...
                                  child: const Icon(Icons.edit_outlined, size: 18, color: AppColors.cianoFrio),
                                ),
                              ),
                            ],
                          ),
